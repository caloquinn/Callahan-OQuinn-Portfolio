# 🔐 Callahan O'Quinn — Cybersecurity Portfolio
...
### 📝 [Blogs](./Blogs/)
Security-focused articles covering current threats and cybersecurity news:
- **[Alleged Nintendo Hack](./Blogs/Alleged%20Nintendo%20Hack.pdf)** — Analysis of the high-profile Nintendo data breach
- **[Data Theft Attack on ChatGPT](./Blogs/Data%20Theft%20Attack%20on%20ChatGPT.pdf)** — Examining prompt-injection and data exfiltration risks in LLMs
- **[New iOS Video Injection Tool for Deepfake Attacks](./Blogs/New%20iOS%20Video%20Injection%20Tool%20for%20Deepfake%20Attacks.pdf)** — Coverage of deepfake tooling targeting mobile platforms
- **[Sleepyduck Malware](./Blogs/Sleepyduck%20Malware.pdf)** — Breakdown of the Sleepyduck malware campaign
- **[VoidProxy Bypassing MFA](./Blogs/VoidProxy%20bypassing%20MFA.pdf)** — How VoidProxy techniques are used to defeat multi-factor authentication

### 🔍 [Penetration Tests](./Pen-Tests/)
Hands-on penetration testing presentations and reports:
- **[Capture the Flags](./Pen-Tests/Capture%20the%20Flags.pdf)** — CTF walkthrough and methodology (presentation)
- **[Metasploit Exploitation](./Pen-Tests/Metasploit%20exploitation.pdf)** — Practical exploitation using Metasploit Framework (presentation)
- **[Penetration Test — Looz](./Pen-Tests/Penetration-Test-Looz.pdf)** — Full penetration test report for a simulated target

### 📋 [Reports & Technical Writing](./Reports%20%26%20Technical%20Writing/)
Formal security documents and case studies:
...
- **[Layered Attacks](./Research/Layered%20Attacks.pdf)** — Research into multi-stage, layered attack strategies
- **[Website Tools](./Research/Website%20Tools.pdf)** — Overview and analysis of common web reconnaissance tools

### 🎓 [Tutorials](./Tutorials/)
Step-by-step security guides:
- **[Network Segmentation](./Tutorials/Network%20Segmentation.pdf)** — Guide to designing and implementing network segmentation
- **[Windows Firewall Configuration](./Tutorials/Windows%20Firewall%20Configuration.pdf)** — Practical walkthrough of Windows Firewall setup and hardening
